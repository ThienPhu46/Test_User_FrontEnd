      ...
      <nav className="nav-container">
        <div className="nav-content">
          ...
          <div className="desktop-nav">
            ...
            <NavLink to="" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}>Khuyến mãi</NavLink>
            <NavLink to="" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}>Đặt phòng</NavLink>
            <NavLink to="" className={({ isActive }) => isActive ? "nav-link active" : "nav-link"}>Liên hệ</NavLink>
          </div>

          <div className="user-info">
            <div className="user-name">
              <img src="/Img_User/user-icon.png" alt="User Icon" className="user-icon" />
              <span className="user-text">Duy Độ</span>
            </div>
            <div className="user-points">
              <img src="/Img_User/coin-icon.png" alt="Coin Icon" className="coin-icon" />
        ...
        {isMenuOpen && (
          <div className="mobile-nav">
            <div className="mobile-nav-links">
              ...
              <a href="/" className="mobile-nav-link">Khuyến mãi</a>
              <a href="/" className="mobile-nav-link">Đặt phòng</a>
              <a href="" className="mobile-nav-link">Liên hệ</a>
            </div>
          </div>
        )}
      </nav>
